...
public:
  enum {
    ...
    T__86 = 87, T__87 = 88, T__88 = 89, T__89 = 90, LBRACKET = 91, RBRACKET = 92, 
    LBRACE = 93, RBRACE = 94, LPAREN = 95, RPAREN = 96, COLON = 97, SEMICOLON = 98, 
    DOT = 99, COMMA = 100, EQUALS = 101, ARROW = 102, PLUS = 103, MINUS = 104, 
    MUL = 105, DIV = 106, MOD = 107, Constant = 108, Whitespace = 109, Newline = 110, 
    Integer = 111, Identifier = 112, RealNumber = 113, TimingLiteral = 114, 
    StringLiteral = 115, LineComment = 116, BlockComment = 117
  };
  ...
  enum {
    ...
    RuleClassicalArgument = 31, RuleClassicalArgumentList = 32, RuleAnyTypeArgument = 33, 
    RuleAnyTypeArgumentList = 34, RuleAliasStatement = 35, RuleIndexIdentifier = 36, 
    RuleIndexIdentifierList = 37, RuleRangeDefinition = 38, RuleQuantumGateDefinition = 39, 
    RuleQuantumGateSignature = 40, RuleQuantumGateName = 41, RuleQuantumBlock = 42, 
    RuleQuantumLoop = 43, RuleQuantumLoopBlock = 44, RuleQuantumStatement = 45, 
    RuleQuantumInstruction = 46, RuleQuantumPhase = 47, RuleQuantumReset = 48, 
    RuleQuantumMeasurement = 49, RuleQuantumMeasurementAssignment = 50, 
    RuleQuantumBarrier = 51, RuleQuantumGateModifier = 52, RulePowModifier = 53, 
    RuleCtrlModifier = 54, RuleQuantumGateCall = 55, RuleUnaryOperator = 56, 
    RuleComparisonOperator = 57, RuleEqualityOperator = 58, RuleLogicalOperator = 59, 
    RuleExpressionStatement = 60, RuleExpression = 61, RuleLogicalAndExpression = 62, 
    RuleBitOrExpression = 63, RuleXOrExpression = 64, RuleBitAndExpression = 65, 
    RuleEqualityExpression = 66, RuleComparisonExpression = 67, RuleBitShiftExpression = 68, 
    RuleAdditiveExpression = 69, RuleMultiplicativeExpression = 70, RuleUnaryExpression = 71, 
    RulePowerExpression = 72, RuleExpressionTerminator = 73, RuleBooleanLiteral = 74, 
    RuleIncrementor = 75, RuleBuiltInCall = 76, RuleBuiltInMath = 77, RuleCastOperator = 78, 
    RuleExpressionList = 79, RuleEqualsExpression = 80, RuleAssignmentOperator = 81, 
    RuleSetDeclaration = 82, RuleProgramBlock = 83, RuleBranchingStatement = 84, 
    RuleLoopSignature = 85, RuleLoopStatement = 86, RuleEndStatement = 87, 
    RuleReturnStatement = 88, RuleControlDirective = 89, RuleExternDeclaration = 90, 
    RuleExternOrSubroutineCall = 91, RuleSubroutineDefinition = 92, RuleSubroutineBlock = 93, 
    RulePragma = 94, RuleTimingType = 95, RuleTimingBox = 96, RuleTimingIdentifier = 97, 
    RuleTimingInstructionName = 98, RuleTimingInstruction = 99, RuleTimingStatement = 100, 
    RuleCalibration = 101, RuleCalibrationGrammarDeclaration = 102, RuleCalibrationDefinition = 103, 
    RuleCalibrationGrammar = 104, RuleCalibrationArgumentList = 105
  };
